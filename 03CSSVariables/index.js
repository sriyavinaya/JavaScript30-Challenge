const inputs = document.querySelectorAll('.controls input');  //for selection of html tags via querySelector, use name only.

inputs.forEach(input => input.addEventListener("change", handleUpdate));
inputs.forEach(input => input.addEventListener("input", handleUpdate));     //using input instead of mouseover 
